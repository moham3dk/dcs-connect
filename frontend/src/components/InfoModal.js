        ...
        <div className="p-6">
          ...
          <div className="flex flex-wrap justify-center items-center mt-4">
            {extracurricular.tags.map((tag, index) => (
              <span key={index} className="bg-primary text-white py-1 px-3 md:py-2 md:px-5 m-2 rounded-full text-sm font-semibold">
                {tag}
              </span>
            ))}
          </div>
          <div className="mt-6 text-center">
            ...
            <p className="text-lg lg:text-xl py-1">
              <span className="font-bold text-primary">Contact Email:</span> {extracurricular.contact[0]?.email || 'N/A'}
            </p>
            <p className="text-lg lg:text-xl py-1">
              <span className="font-bold text-primary">Contact Phone Number:</span> {extracurricular.contact[0]?.phone || 'N/A'}
            </p>
          </div>
